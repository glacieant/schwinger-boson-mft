...
2. Constructing the interacting Schwinger boson representation of
   the Heisenberg-Zeeman spin Hamiltonian in real space for the graph.
...
2. The computational complexity of the nested loop-sums is
   tackled by cpu/gpu based **parallelization** on cluster and local 
   computers with compatible hardware.
...
[3] S. Dey, J. Maciejko, and M. Vojta, [Field-driven transition from quantum spin liquid to magnetic order in triangular-lattice antiferromagnets](https://doi.org/10.1103/PhysRevB.109.224424), Phys. Rev. B 109, 224424 (2024).
